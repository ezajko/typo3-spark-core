...
$temporaryColumns = [
    ...
    'tx_spark_subheader_link_text' => [
        'exclude' => true,
        'label' => 'Subheader Link Text',
        'config' => [
            'type' => 'input',
            'eval' => 'trim',
        ],
    ],
    'tx_spark_subheader_link_url' => [
        'exclude' => true,
        'label' => 'Subheader Link URL',
        'config' => [
            'type' => 'link',
            'allowedTypes' => ['page', 'url', 'file', 'email', 'folder'],
        ],
    ...
    'tx_spark_gutter_x' => [
        'exclude' => true,
        'label' => 'Horizontal Gutter (Gap X)',
        'config' => [
            'type' => 'select',
            'renderType' => 'selectSingle',
            'items' => [
                ['label' => 'Default (Based on Bootstrap)', 'value' => ''],
                ['label' => 'None (gx-0)', 'value' => 'gx-0'],
                ['label' => 'Extra Small (gx-1)', 'value' => 'gx-1'],
                ['label' => 'Small (gx-2)', 'value' => 'gx-2'],
                ['label' => 'Medium (gx-3)', 'value' => 'gx-3'],
                ['label' => 'Large (gx-4)', 'value' => 'gx-4'],
                ['label' => 'Extra Large (gx-5)', 'value' => 'gx-5'],
            ],
            'default' => '',
        ],
    ],
    'tx_spark_gutter_y' => [
        'exclude' => true,
        'label' => 'Vertical Gutter (Gap Y)',
        'config' => [
            'type' => 'select',
            'renderType' => 'selectSingle',
            'items' => [
                ['label' => 'Default (Based on Bootstrap)', 'value' => ''],
                ['label' => 'None (gy-0)', 'value' => 'gy-0'],
                ['label' => 'Extra Small (gy-1)', 'value' => 'gy-1'],
                ['label' => 'Small (gy-2)', 'value' => 'gy-2'],
                ['label' => 'Medium (gy-3)', 'value' => 'gy-3'],
                ['label' => 'Large (gy-4)', 'value' => 'gy-4'],
                ['label' => 'Extra Large (gy-5)', 'value' => 'gy-5'],
            ],
            'default' => '',
        ],
    ],
    'tx_spark_valign' => [
        ...
        'config' => [
            ...
            'items' => [
                ...
                ['label' => 'Top (align-items-start)', 'value' => 'align-items-start'],
                ['label' => 'Center (align-items-center)', 'value' => 'align-items-center'],
                ['label' => 'Bottom (align-items-end)', 'value' => 'align-items-end'],
            ],
            'default' => '',
        ],
    ],
    'tx_spark_padding_y' => [
        ...
        'config' => [
            ...
            'items' => [
                ['label' => 'None', 'value' => ''],
                ['label' => 'Extra Small (py-1)', 'value' => 'py-1'],
                ['label' => 'Small (py-2)', 'value' => 'py-2'],
                ['label' => 'Medium (py-3)', 'value' => 'py-3'],
                ['label' => 'Large (py-4)', 'value' => 'py-4'],
                ['label' => 'Extra Large (py-5)', 'value' => 'py-5'],
                ['label' => 'Section Padding (py-5+)', 'value' => 'py-5'],
            ],
            'default' => '',
        ],
    ],
    'tx_spark_padding_x' => [
        'exclude' => true,
        'label' => 'Inner Padding Horizontal (px)',
        'config' => [
            'type' => 'select',
            'renderType' => 'selectSingle',
            'items' => [
                ['label' => 'None', 'value' => ''],
                ['label' => 'Extra Small (px-1)', 'value' => 'px-1'],
                ['label' => 'Small (px-2)', 'value' => 'px-2'],
                ['label' => 'Medium (px-3)', 'value' => 'px-3'],
                ['label' => 'Large (px-4)', 'value' => 'px-4'],
                ['label' => 'Extra Large (px-5)', 'value' => 'px-5'],
            ],
            'default' => '',
        ],
    ],
    'tx_spark_columns' => [
        'exclude' => true,
        'label' => 'Columns per Row (Grid Layout)',
        'config' => [
            'type' => 'select',
            'renderType' => 'selectSingle',
            'items' => [
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addTCAcolumns('tt_content', $temporaryColumns);
    ...
    $GLOBALS['TCA']['tt_content']['palettes']['headers']['showitem'] = '
        ...
        --linebreak--,
        tx_spark_header_link_text, tx_spark_header_link_url,
        --linebreak--,
        ...
        --linebreak--,
        tx_spark_subheader_link_text, tx_spark_subheader_link_url,
        --linebreak--,
        subheader_class,
        --linebreak--,
    ...
    // Palette: Container Grid Settings
    $GLOBALS['TCA']['tt_content']['palettes']['spark_grid_settings']['showitem'] = '
        tx_spark_gutter_x, tx_spark_gutter_y,
        --linebreak--,
        tx_spark_valign, tx_spark_padding_y
    ';

    // Standard Container ShowItem Configuration (with Headers and Grid Settings)
    $containerShowItem = '
        --div--;LLL:EXT:core/Resources/Private/Language/Form/locallang_tabs.xlf:general,
            --palette--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:palette.general;general,
            --palette--;;headers,
        --div--;LLL:EXT:b13/container/Resources/Private/Language/locallang.xlf:container.colPos,
            --palette--;;container_columns,
        --div--;LLL:EXT:core/Resources/Private/Language/Form/locallang_tabs.xlf:appearance,
            --palette--;;frames,
...
if (\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::isLoaded('container')) {
    ...
    $GLOBALS['TCA']['tt_content']['palettes']['spark_grid_settings']['showitem'] = '
        tx_spark_gutter_x, tx_spark_gutter_y,
        --linebreak--,
        tx_spark_padding_x, tx_spark_padding_y,
        --linebreak--,
        tx_spark_valign, tx_spark_columns
    ';
    ...
    foreach ($containerTypes as $containerType) {
        $GLOBALS['TCA']['tt_content']['types'][$containerType]['showitem'] = $containerShowItem;
    }
}
